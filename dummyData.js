...
const addDummyData = async () => {
  ...
  await locationService.createMall(locationData1);
  await locationService.createlocation(locationData2);

  
  let kiosk = await Kiosk.create({ address: '1 Sengkang Square', description: 'Sample Description', locationId: 1 });
  let kiosk2 = await Kiosk.create({ address: '3155 Commonwealth Ave West', description: 'Sample Description', locationId: 2 });
